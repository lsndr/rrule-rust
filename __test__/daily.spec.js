...
test('Daily for 10 occurrences', (t) => {
  ...
  t.deepEqual(dates, [
    873205200000, 873291600000,
    873378000000, 873464400000,
    873550800000, 873637200000,
    873723600000, 873810000000,
    873896400000, 873982800000
  ]);
});
...
test('Every Monday in January, for 3 years', (t) => {
  ...
  t.deepEqual(dates, [
    884008800000, 884613600000,
    885218400000, 885823200000,
    915458400000, 916063200000,
    916668000000, 917272800000,
    946908000000, 947512800000,
