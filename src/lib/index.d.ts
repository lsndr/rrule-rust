...
export declare class ExDate {
  constructor(dates: Float64Array, tzid?: string | undefined | null)
...
export declare class RRule {
  ...
  get until(): Float64Array | null
  toString(): string
}

export declare class RRuleSet {
  constructor(dtstart: Float64Array, tzid?: string | undefined | null, dtstartValue?: string | undefined | null, rrules?: (readonly RRule[]) | undefined | null, exrules?: (readonly RRule[]) | undefined | null, exdates?: (readonly ExDate[]) | undefined | null, rdates?: (readonly RDate[]) | undefined | null)
  get tzid(): string | null
  get dtstart(): Float64Array
  get rrules(): RRule[]
  get exrules(): RRule[]
  get exdates(): ExDate[]
  get rdates(): RDate[]
  static parse(str: string): RRuleSet
  all(limit?: number | undefined | null): Float64Array
  between(afterDatetime: Float64Array, beforeDatetime: Float64Array, inclusive?: boolean | undefined | null): Float64Array
...
export declare class RRuleSetIterator {
  next(store: Float64ArraySlice): boolean | Float64Array | null
