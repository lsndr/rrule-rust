...
test('Weekly for 10 occurrences', () => {
  ...
  expect(dates).toEqual([
    ...
    DateTime.fromDate(1997, 10, 7, 9, 0, 0, false),
    DateTime.fromDate(1997, 10, 14, 9, 0, 0, false),
    DateTime.fromDate(1997, 10, 21, 9, 0, 0, false),
...
test('Weekly until December 24, 1997', () => {
  const rrule = new RRule(Frequency.Weekly).setUntil(
    DateTime.fromDate(1997, 12, 24, 0, 0, 0, false),
  );
  const set = new RRuleSet(
    DateTime.fromDate(1997, 9, 2, 9, 0, 0, false),
    'US/Eastern',
  ...
  expect(dates).toEqual([
    ...
    DateTime.fromDate(1997, 12, 9, 9, 0, 0, false),
...
test('Every other week on Monday, Wednesday and Friday until December 24, 1997, but starting on Tuesday, September 2, 1997', () => {
  ...
  expect(dates).toEqual([
    ...
    DateTime.fromDate(1997, 9, 17, 9, 0, 0, false),
    DateTime.fromDate(1997, 9, 19, 9, 0, 0, false),
    DateTime.fromDate(1997, 9, 29, 9, 0, 0, false),
    DateTime.fromDate(1997, 10, 1, 9, 0, 0, false),
    DateTime.fromDate(1997, 10, 3, 9, 0, 0, false),
    DateTime.fromDate(1997, 10, 13, 9, 0, 0, false),
    DateTime.fromDate(1997, 10, 15, 9, 0, 0, false),
    DateTime.fromDate(1997, 10, 17, 9, 0, 0, false),
    DateTime.fromDate(1997, 10, 27, 9, 0, 0, false),
    DateTime.fromDate(1997, 10, 29, 9, 0, 0, false),
    DateTime.fromDate(1997, 10, 31, 9, 0, 0, false),
    DateTime.fromDate(1997, 11, 10, 9, 0, 0, false),
    DateTime.fromDate(1997, 11, 12, 9, 0, 0, false),
    DateTime.fromDate(1997, 11, 14, 9, 0, 0, false),
    DateTime.fromDate(1997, 11, 24, 9, 0, 0, false),
    DateTime.fromDate(1997, 11, 26, 9, 0, 0, false),
    DateTime.fromDate(1997, 11, 28, 9, 0, 0, false),
    DateTime.fromDate(1997, 12, 8, 9, 0, 0, false),
    DateTime.fromDate(1997, 12, 10, 9, 0, 0, false),
